...
export class ViewBookedEventComponent implements OnInit {
  ...
  constructor(private activatedRoute:ActivatedRoute,private router:Router,private bookedService:BookEventService,private loginService:UserloginService) { }
  ...
  getBookedEvents(){
    this.bookedService.getAllByUserId(this.loginService.User.id).subscribe((data)=>{
      console.log(data);
      this.events=data;
    })
  }
